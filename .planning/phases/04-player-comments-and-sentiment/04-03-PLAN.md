...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <what-built>
    ...
    - Model used: lxyuan/distilbert-base-multilingual-cased-sentiments-student (NOT rajkumar4466 — that model is not deployed on HF Inference API)
...
- HuggingFace lxyuan model classifies comments correctly (COMM-02)
